...
class ExportLostItem implements FromCollection, WithHeadings, WithTitle
{
    public function title(): string
    {
        return 'Lost Items'; // Custom sheet name for lost items
    }
    ...
    {
        $items = Item::where('information', false)
